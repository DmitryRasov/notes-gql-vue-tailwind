  ...
  <main>
    ...
    <form @submit.prevent="registerOrLogin">
      ...
      <label class="block mb-4">
        ...
        <input type="email" v-model="email" class="block w-100 text-slate-800 px-4 py-2" />
      </label>

      <label class="block mb-4">
        <span class="block text-sm uppercase mb-2">Password</span>
        <input type="password" v-model="password" class="block w-100 text-slate-800 px-4 py-2" />
      </label>
